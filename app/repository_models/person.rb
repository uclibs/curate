...
class Person < ActiveFedora::Base
  ...
  has_and_belongs_to_many :editable_works, class_name: "::ActiveFedora::Base", property: :is_editor_of, inverse_of: :has_editor
  alias_method :works, :editable_works
  has_and_belongs_to_many :readable_works, class_name: "::ActiveFedora::Base", property: :is_reader_of, inverse_of: :has_reader
