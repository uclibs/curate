  ...
  task :load => :environment do
    ...
    works.each do |work|
      ...
      if wl.create
        ...
        ## setting representative - it doesn't matter that we're using the GenericWork class - the worktype is preserved
        w = GenericWork.find(wl.curation_concern.pid)
        w.representative = w.generic_file_ids.first
        w.save
      else
